    ...
    <Layout>
      ...
      <div className="w-full bg-[#eee] flex justify-center">
        <Box
          ...
          className="lg:w-[1170px] w-full py-6 px-4 "
        >
          ...
          <div className="text-[16px] mb-3">
            ...
            {/* <p className="break-words text-[#337ab7]">
              media@blueskycapitalmanagement.com.
            </p> */}
          </div>
          <p className="text-[16px] mb-3">
          ...
          <div className="grid md:grid-cols-2 grid-cols-1 gap-4">
            {ContactInfo.map((item) => (
              <div key={item.name} className="mb-3">
                <p className="mb-1 text-bold text-[#3298eb] text-base">
                  {item.name}
                </p>
                <input

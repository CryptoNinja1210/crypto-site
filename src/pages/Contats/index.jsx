        ...
        <div className="lg:w-[1170px] w-full p-4 mt-16 md:mt-24">
          <div className="grid md:grid-cols-2 grid-cols-1 gap-4">
            ...
            <div>
              ...
              <div className="mb-3">
                <span className="mb-1 text-bold  text-base">Phone number</span>
                <span className="text-red-600"> * </span>
                <MuiTelInput
                  id="phone-number"
                  sx={{ width: "100%", bgcolor: "white" }}
          ...
          <div className="mb-3">
            <label htmlFor="user_message1" className="">
              {" "}
              Message (optional)
            </label>
            <InputBase
          ...
          <div className="hover:opacity-80 duration-500 w-32 mx-4 px-7 my-auto py-3 rounded-md cursor-pointer text-white bg-[#00306e]">
            SUBMIT
          </div>
        </div>
      </div>
